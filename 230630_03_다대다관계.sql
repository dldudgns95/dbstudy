...
CREATE TABLE SUBJECT_T(
    SBJ_CODE  VARCHAR2(5)  NOT NULL,
    SBJ_NAME  VARCHAR2(10) NOT NULL,
...
CREATE TABLE ENROLL_T(
    ...
    CONSTRAINT FK_UNIV_STU_ENR FOREIGN KEY(STU_NO)   REFERENCES UNIV_STUDENT_T(STU_NO),
    CONSTRAINT FK_SBJ_ENR FOREIGN KEY(SBJ_CODE) REFERENCES SUBJECT_T(SBJ_CODE)
);
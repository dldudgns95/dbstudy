...
INSERT INTO BOOK_T VALUES(BOOK_SEQ.NEXTVAL,  '축구아는 여자',    '나이스북',   13000);
...
INSERT INTO ORDER_T(ORDER_ID, CUST_ID, BOOK_ID, AMOUNT) VALUES('230701'||'-'||ORDER_SEQ.NEXTVAL, 1000, 1,  1);
INSERT INTO ORDER_T(ORDER_ID, CUST_ID, BOOK_ID, AMOUNT) VALUES('230703'||'-'||ORDER_SEQ.NEXTVAL, 1000, 3,  2);
INSERT INTO ORDER_T(ORDER_ID, CUST_ID, BOOK_ID, AMOUNT) VALUES('230703'||'-'||ORDER_SEQ.NEXTVAL, 1001, 5,  1);
INSERT INTO ORDER_T(ORDER_ID, CUST_ID, BOOK_ID, AMOUNT) VALUES('230704'||'-'||ORDER_SEQ.NEXTVAL, 1002, 6,  2);
INSERT INTO ORDER_T(ORDER_ID, CUST_ID, BOOK_ID, AMOUNT) VALUES('230705'||'-'||ORDER_SEQ.NEXTVAL, 1003, 7,  3);
INSERT INTO ORDER_T(ORDER_ID, CUST_ID, BOOK_ID, AMOUNT) VALUES('230706'||'-'||ORDER_SEQ.NEXTVAL, 1000, 2,  5);
INSERT INTO ORDER_T(ORDER_ID, CUST_ID, BOOK_ID, AMOUNT) VALUES('230707'||'-'||ORDER_SEQ.NEXTVAL, 1003, 8,  2);
INSERT INTO ORDER_T(ORDER_ID, CUST_ID, BOOK_ID, AMOUNT) VALUES('230708'||'-'||ORDER_SEQ.NEXTVAL, 1002, 10, 2);
INSERT INTO ORDER_T(ORDER_ID, CUST_ID, BOOK_ID, AMOUNT) VALUES('230709'||'-'||ORDER_SEQ.NEXTVAL, 1001, 10, 1);
INSERT INTO ORDER_T(ORDER_ID, CUST_ID, BOOK_ID, AMOUNT) VALUES('230710'||'-'||ORDER_SEQ.NEXTVAL, 1002, 6,  4);
...
SELECT O.ORDER_ID 
  ...
  FROM BOOK_T B INNER JOIN ORDER_T O
    ...
    ON C.CUST_ID = O.CUST_ID
 WHERE EXTRACT(DAY FROM O.ORDER_DT) NOT BETWEEN 04 AND 07;
